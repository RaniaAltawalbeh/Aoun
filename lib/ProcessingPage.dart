...
String k = "ترتيب من الأحدث إلى الأقدم";

final activeColor = Color(0xFF2269D4);
...
class _ProcessingPageState extends State<ProcessingPage> {
  final activeColor = Color(0xFF2269D4);
  final processingReports =
  reports.where((r) => r["status"] == "processing").toList();
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: processingReports.length,
                  itemBuilder: (context, index) {
                    final report = processingReports[index];
